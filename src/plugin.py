...
class HumbleBundlePlugin(Plugin):
    ...
    @staticmethod
    def _normalize_subscription_name(machine_name: str, is_latest: bool):
        month_map = {
            'january': '01',
            'february': '02',
            'march': '03',
        ...
        active_month_marker = "✦ " if is_latest else ""

        return f'Humble {type_.title()} {active_month_marker}{year}-{month_map[month]}'
    ...
    async def get_subscriptions(self):
        ...
        if not active_content_unlocked:
            ...
            subscriptions.append(Subscription(
                self._normalize_subscription_name(active_month.machine_name, True),
